...
while($res = $results->fetchArray(SQLITE3_ASSOC)){ 
        ...
        // se verifica si la noticia es de hoy (este script es
        // para las estadisticas de las noticias solode hoy).
        // Si no es de hoy se continua con la sigiuente
