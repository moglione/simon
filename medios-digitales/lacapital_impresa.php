...
$url = "http://www.lacapital.com.ar/secciones/edicion_impresa.html";
//$url = "http://www.lacapital.com.ar/contenidos/edicion_impresa.html?fecha=1488164400";
//$url = "http://www.lacapital.com.ar/contenidos/edicion_impresa.html?fecha=1488078000";
//$url = "http://www.lacapital.com.ar/contenidos/edicion_impresa.html?fecha=1487991600";
...
for($n=0;$n<$tope;$n++){
    ...
    //se genera el url par al anvegacion interna
    $pieces = explode("/", $url);
    $urlinterno=$pieces[3];
    $nombreArchivo=$n+1;
    ...
    if($row<=0)
    {
      ...
      consolelog( "Ya esta, la noticia no se inserta");  
    }
