...
$final=strtotime("march 30 2017");
$inicio=strtotime("march 23 2017");


$sqlquery= "SELECT * FROM news WHERE epocnews > $inicio AND epocnews < $final AND medio='canal 5'  ORDER BY epocnews ASC";
...
while($res = $results->fetchArray(SQLITE3_ASSOC)){ 
        ...
        foreach($trigers_words as $key => $value){
         ...
         $gestion="";
         if ($pertinente==true)$gestion="#### NOTICIA DE GESTION #####<br>";
