...
while($res = $results->fetchArray(SQLITE3_ASSOC)){ 
        ...
        // se arma una array con los titulares
        // de las noticias pertinentes de los medios digitales
        // de las ultimas 20 horas
        if ($res['origen'] != "REC"){
          $hoy=strToTime("-20 hours");
          $tit=$res['titulo'];
          ...
          if( $res['epocnews'] >= $hoy ) 
          {
            ...
            $nota['humor']=$resultado['sentimiento'];
            $nota['url']=$res['url'];

            $titulares[$medio][]=$nota;
...
///////////////////////////////////////////////////////////////////
// se limpia el texto de algunas entidades
$entidades=contarPersonajes($totaltexto, 10);
